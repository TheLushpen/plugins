...
void FLTAVFoundationVideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTAVFoundationVideoPlayerApi> *api) {
  ...
  }
  {
  ...
  }
    {
        FlutterBasicMessageChannel *channel =
                [[FlutterBasicMessageChannel alloc]
                        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.setAudio"
                     binaryMessenger:binaryMessenger
                               codec:FLTAVFoundationVideoPlayerApiGetCodec()        ];
        if (api) {
            [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
    ...
    }
    {
        FlutterBasicMessageChannel *channel =
                [[FlutterBasicMessageChannel alloc]
                        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.setAudioByIndex"
                     binaryMessenger:binaryMessenger
                               codec:FLTAVFoundationVideoPlayerApiGetCodec()        ];
        if (api) {
            [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
    ...
    }
    {
        FlutterBasicMessageChannel *channel =
                [[FlutterBasicMessageChannel alloc]
                        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.getAudios"
                     binaryMessenger:binaryMessenger
                               codec:FLTAVFoundationVideoPlayerApiGetCodec()        ];
        if (api) {
            [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
  ...
  }
  {
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTPictureInPictureMessage *arg_arg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api setPictureInPicture:arg_arg error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.showAirPlayMenu"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(showAirPlayMenu:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(showAirPlayMenu:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTTextureMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api showAirPlayMenu:arg_msg error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
