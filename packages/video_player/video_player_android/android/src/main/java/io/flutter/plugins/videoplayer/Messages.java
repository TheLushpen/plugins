...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class PictureInPictureMessage {
    private @NonNull Long textureId;
    public @NonNull Long getTextureId() { return textureId; }
    public void setTextureId(@NonNull Long setterArg) {
      if (setterArg == null) {
    ...
    private @NonNull Long enabled;
    public @NonNull Long getEnabled() { return enabled; }
    public void setEnabled(@NonNull Long setterArg) {
      if (setterArg == null) {
    ...
    public static final class Builder {
      ...
      private @Nullable Long enabled;
      public @NonNull Builder setEnabled(@NonNull Long setterArg) {
        this.enabled = setterArg;
        return this;
      }
      private @Nullable Double left;
    ...
    static @NonNull PictureInPictureMessage fromMap(@NonNull Map<String, Object> map) {
      PictureInPictureMessage pigeonResult = new PictureInPictureMessage();
      Object textureId = map.get("textureId");
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId));
      ...
      } else 
{
  ...
  public interface AndroidVideoPlayerApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, AndroidVideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setPictureInPicture", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ArrayList<Object> args = (ArrayList<Object>)message;
              PictureInPictureMessage argArg = (PictureInPictureMessage)args.get(0);
              if (argArg == null) {
